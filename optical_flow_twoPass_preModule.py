...
# The module efforts
from motion_core.filtering import threshold_mag, apply_keep_mask, build_keep_mask
...
def detect_motion_frames(
    ...
    for idx in range(1, total_frames):
        ...
        # ---------------------------------------------------------
        # Step 3 splice: collect per-frame motion pixel count - Bifurcation
        # ---------------------------------------------------------
        if state.collect_motion_metrics:
            motion_pixels = active_gated
            state.motion_pixels_per_frame.append(motion_pixels)
        # ---------------------------------------------------------
